...
from gamerapi.models import Game, Player
from gamerapi.views.game import GameSerializer


class GameTests(APITestCase):

    # Add any fixtures you want to run to build the test database
    fixtures = ['users', 'tokens', 'players', 'games', 'categories']
    ...
    def test_create_game(self):
        ...
        game = {
            "title": "Uno",
            "description": "Person who gets rid of all their cards wins.",
            "designer": "Mattel, Inc",
            "year_released": 1971,
        ...
        # The _executed_ output should com first when using an assertion with 2 arguments
